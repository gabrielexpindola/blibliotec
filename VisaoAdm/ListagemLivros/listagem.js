...
function mostrarPagina() {
    ...
    livros.forEach((livro, posicao) => {
        ...
        // fim = 4
        // Verifica se o indice ou posição do livro está dentro do intervalo da página atual.
...
// Evento de clique do botão de próxima página
...
// Que não pertencem à primeira página
mostrarPagina();